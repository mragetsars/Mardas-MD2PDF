...
عبارت‌های ریاضی درون‌خطی مثل $T=500$، $\epsilon=0.05$، $\Sigma=I$ و $E=mc^2$ باید وسط متن فارسی به‌درستی با MathJax رندر شوند و نباید به شکل خامی مثل `\epsilon` یا پرانتزهای نامرتب چاپ شوند. این حالت مخصوصاً در عنوان‌ها و فهرست مطالب هم مهم است.
