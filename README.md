...
- خروجی PDF با قالب حرفه‌ای، cover، رنگ‌بندی، جدول‌های شکیل، blockquote و callout
...
- جدول‌ها داخل wrapper قرار می‌گیرند تا border-radius، shadow و صفحه‌بندی بهتری داشته باشند.
